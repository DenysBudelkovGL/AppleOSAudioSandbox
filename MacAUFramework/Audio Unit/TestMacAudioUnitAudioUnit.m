...
@interface TestMacAudioUnitAudioUnit ()
...
@implementation TestMacAudioUnitAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[TestMacAudioUnitDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block TestMacAudioUnitDSPKernelAdapter * kernelAdapter = _kernelAdapter;
