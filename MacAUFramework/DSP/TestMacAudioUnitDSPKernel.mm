...
#import "TestMacAudioUnitDSPKernel.hpp"
#import "TestMacAudioUnitDSPKernelAdapter.h"

@implementation TestMacAudioUnitDSPKernelAdapter {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    TestMacAudioUnitDSPKernel  _kernel;
...
- (instancetype)init {
    ...
    if (self = [super init]) {
        AVAudioFormat *format = [[AVAudioFormat alloc] initStandardFormatWithSampleRate:96000 channels:2];
...
- (AUInternalRenderBlock)internalRenderBlock {
    ...
    __block TestMacAudioUnitDSPKernel *state = &_kernel;
