//
//  TestMacAudioUnitDSPKernel.hpp
//  TestMacAudioUnit
//
//  Created by Denys Budelkov on 11.08.2021.
//

#ifndef TestMacAudioUnitDSPKernel_hpp
#define TestMacAudioUnitDSPKernel_hpp
...
/*
 TestMacAudioUnitDSPKernel
 Performs simple copying of the input signal to the output.
 As a non-ObjC class, this is safe to use from render thread.
 */
class TestMacAudioUnitDSPKernel : public DSPKernel {
public:
...
private:
    int chanCount = 0;
    float sampleRate = 96000.0;
    bool bypassed = false;
    AudioBufferList* inBufferListPtr = nullptr;
    AudioBufferList* outBufferListPtr = nullptr;
};

#endif /* TestMacAudioUnitDSPKernel_hpp */
